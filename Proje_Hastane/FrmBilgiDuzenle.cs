...
namespace Proje_Hastane
{
    public partial class FrmBilgiDuzenle : Form
    {
        ...
        private void btnBilgiGuncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut2 = new SqlCommand("update Tbl_Hastalar set HastaAd=@p1,HastaSoyad=@p2,HastaTelefon=@p3,HastaSifresi=@p4,HastaCinsiyet=@p5 Where HastaTC=@p6", bgl.baglanti());
